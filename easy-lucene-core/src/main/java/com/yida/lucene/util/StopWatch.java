...
public class StopWatch {
	...
	public String shortSummary(TimeUnit unit) {
		...
		return String.format("StopWatch '%s': running time = %s %s",
				this.id, getTotal(unit), getShotName(unit));
	}
	...
	public String prettyPrint(TimeUnit unit) {
		...
		if (null == this.taskList) {
			...
			sb.append(getShotName(unit)).append("         %     Task name").append(System.lineSeparator());
			sb.append("---------------------------------------------").append(System.lineSeparator());
